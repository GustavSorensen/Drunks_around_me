...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private MapsActivityViewModel vm;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        vm = new MapsActivityViewModel(this.getApplication());
     ...
     * If Google Pe lay services is not installed on the device, thuser will be prompted to install
